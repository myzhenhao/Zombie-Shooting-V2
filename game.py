...
def draw():
    ...
    if game_over:
        ...
        screen.draw.text('Zombie Shooting', centerx=WIDTH/2, centery=170, color="black", fontsize=60)
        screen.draw.text('Press K Key to start', centerx=WIDTH/2, centery=270, color="black", fontsize=30)
